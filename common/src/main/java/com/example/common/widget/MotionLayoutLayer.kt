...
class MotionLayoutLayer @JvmOverloads constructor(
    context: Context,
    ...
    private lateinit var  touchableArea: View
...
//            .inflate(R.layout.video_overlay_small, this, false) as MotionLayout
